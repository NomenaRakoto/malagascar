...
Route::get('/covoiturage-madagascar', function () {
    return view('covoiturage-madagascar');
})->name('covoiturage');

Route::get('/covoiturage-madagascar-securite', function () {
...
Route::get('/registration-mail', '\App\Http\Controllers\LoginController@registerMail')->name('register_mail');
...
/**COVOITURAGE**/
Route::get('/covoiturage/proposer', '\App\Http\Controllers\CovoiturageController@create')->name('covoiturage.proposer');
;
Route::get('/covoiturage/search', '\App\Http\Controllers\CovoiturageController@index')->name('covoiturage.search');
Route::get('/covoiturage/detail', '\App\Http\Controllers\CovoiturageController@detail')->name('covoiturage.detail');
Route::post('/covoiturage/save', '\App\Http\Controllers\CovoiturageController@save')->name('covoiturage.save');

/***PROFIL UTILISATEUR***/
Route::get('/covoiturage/utilisateur/profil/{name}/{user_id}', '\App\Http\Controllers\UserController@profil')->name('covoiturage.user.profil');
Route::get('/covoiturage/avis/{name}/{user_id}', '\App\Http\Controllers\UserController@avis')->name('covoiturage.user.avis');
Route::get('/covoiturage/user/email/verify', '\App\Http\Controllers\LoginController@verify')->name('covoiturage.user.mail.verify');
Route::post('/covoiturage/user/email/verify_code', '\App\Http\Controllers\LoginController@verifyAccount')->name('covoiturage.user.mail.verify.code');

Route::post('/covoiturage/avis/save', '\App\Http\Controllers\UserController@saveAvis')->name('user.avis.save');


Route::get('/upload', '\App\Http\Controllers\CovoiturageController@create')
;
