...
class UserController extends Controller
{
    ...
    public function profil(Request $request, $name, $user_id)
    {
        $user = User::find($user_id);      
        return view('user.profil', ['user' => $user]);
    }

    public function avis(Request $request, $name, $user_id)
    {
        $user = User::find($user_id);  
        $profil_avis = UserProfilAvis::where('user_profil_id', $user_id)->get();    
        return view('user.avis', ['user' => $user, 'profil_avis' => $profil_avis ]);
    }
    ...
    public function saveAvis(Request $request)
    {
        ...
        $avis = UserProfilAvis::create($data); 
